...
def plot_images(data_path, label_path, out_path, name, grade, idh_mutant):
    ...
    # Read Image
    T1_itk =  sitk.ReadImage(os.path.join(data_path, name, name+'_T1.nii.gz'))
    T1C_itk =  sitk.ReadImage(os.path.join(data_path, name, name+'_T1C.nii.gz'))
    T2_itk =  sitk.ReadImage(os.path.join(data_path, name, name+'_T2.nii.gz'))
    FLAIR_itk =  sitk.ReadImage(os.path.join(data_path, name, name+'_FLAIR.nii.gz'))

...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 num_heads=12, mlp_ratio=4., qkv_bias=False, qk_norm = False, mlp_head=False, drop_rate=0., attn_drop_rate=0., 
                 norm_layer=None, hook=False):
        super().__init__()
        ...
        self.blocks = nn.ModuleList([
            Block(
                ...
                qk_norm=qk_norm, drop=drop_rate, attn_drop=attn_drop_rate, norm_layer=norm_layer, hook=hook)

...
@hydra.main(version_base="1.3", config_path="./configs", config_name="internal_eval.yaml")
...
def test_worker(cfg):
    ...
    best_thres = evaluate(net, test_loader, cfg, distributed)
    print("RETURN: " + str(best_thres)) # Do not remove this print line, this is for capturing the path of model



def evaluate(net, data_loader, cfg, distributed):

    metric_dict, val_pred_and_label = test(net, data_loader, cfg, distributed)

...
clini_info_style="random"
embed_trainable="False"
decoder_depth="2"
clini_embed_token="cls"

save_dir="./exp/multiruns/1p_19q/20231221/153723/"
end_num_of_exp=0 # num of exp - 1
...
do
    ...
    BEST_THRES=$(python eval_internal_clinical.py task_name=val ckpt=$single_ckpt paths.save_dir=$save_dir \
                ...
                model.clini_info_style=${clini_info_style[i]} model.embed_trainable=$embed_trainable \
